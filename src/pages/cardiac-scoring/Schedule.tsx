// Schedule section for the Cardiac Calcium Scoring page.
// Final content section before the footer. Contains a two-column CTA card
// prompting at-risk patients to book a CAC scoring appointment.
// Uses z-10 (not z-20) to match this page's lower z-index stack.
import { Phone } from "lucide-react";
import scheduleImage from "../../assets/cardiac-scoring/5.png";
import { DotGrid, Rings } from "./Decorations";

const Schedule = () => {
  return (
    // relative z-10: lower than other service pages (z-20) to match the cardiac
    // page's z-index convention (Hero z-0, Experience/InfoSection/Schedule z-10).
    // bg-white provides a clean break from the light-blue InfoSection above.
      ...
      <div className="relative w-full grid overflow-hidden rounded-xl bg-[#b8dff0] shadow-xl md:grid-cols-[1fr_1.05fr]">
        ...
        <div className="relative z-10 px-8 py-9 md:px-16">
          <h2 className="text-2xl font-bold text-[#1a2b5e] sm:text-2xl">
           Schedule Your Cardiac Scoring Appointment
          </h2>
          <p className="mt-6 text-md text-[#2a4a6e]">A single scan that takes minutes could tell you something your annual checkup cannot. If you or your physician believe this screening is right for you, we are ready to help.</p>
