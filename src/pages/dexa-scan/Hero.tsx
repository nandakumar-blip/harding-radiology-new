// Hero section for the DEXA Scan page.
...
import heroImage from "../../assets/dexa-scan/dexa.jpg";
import { DotGrid, Rings, SoftCircle } from "./Decorations";

const Hero = () => {
  return (
    <section
      // sticky + z-10: stays fixed while the user scrolls until the next section
      ...
      style={{
        // Left-to-right gradient fades from near-opaque white to semi-transparent so the
        // background photo is visible on the right while left-aligned text stays readable.
...
Quick and Painless Bone Density Check
          </h1>
